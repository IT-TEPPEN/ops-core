...
func (m *MockRepository) Save(ctx context.Context, repo entity.Repository) error {
	args := m.Called(ctx, repo)
	return args.Error(0)
}

// FindByURL is a mock implementation of the repository.FindByURL method
func (m *MockRepository) FindByURL(ctx context.Context, url string) (entity.Repository, error) {
...
func (m *MockRepository) FindByID(ctx context.Context, id string) (entity.Repository, error) {
...
func (m *MockRepository) FindAll(ctx context.Context) ([]entity.Repository, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
