...
func (m *MockGitManager) EnsureCloned(ctx context.Context, repo entity.Repository) (string, error) {
	args := m.Called(ctx, repo)
	return args.String(0), args.Error(1)
}

// ListRepositoryFiles is a mock implementation of the GitManager.ListRepositoryFiles method
func (m *MockGitManager) ListRepositoryFiles(ctx context.Context, localPath string, repo entity.Repository) ([]string, error) {
...
func (m *MockGitManager) ReadManagedFileContent(ctx context.Context, localPath string, filePath string, repo entity.Repository) ([]byte, error) {
