...
func TestRegisterRepositoryIntegration(t *testing.T) {
	...
	t.Run("RegisteredRepositoryCanBeRetrieved", func(t *testing.T) {
		...
		var getResponse schema.RepositoryResponse
...
func TestRepositoryEndToEndFlow(t *testing.T) {
	...
	var repoResponse schema.RepositoryResponse
	...
	var listResponse schema.ListRepositoriesResponse
	...
	tokenRequest := schema.UpdateAccessTokenRequest{
