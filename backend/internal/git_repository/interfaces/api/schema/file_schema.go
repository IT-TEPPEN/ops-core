...
// SelectFilesRequest represents the API request body for selecting files
...
// SelectFilesResponse represents the API success response for selecting files
...
// GetMarkdownResponse represents the API response containing selected Markdown content
