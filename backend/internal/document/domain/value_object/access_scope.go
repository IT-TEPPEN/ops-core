...
// Private documents are only accessible to the owner, but can be shared with specific users or groups.
type AccessScope string

const (
	// AccessScopePublic represents public access (all users).
	AccessScopePublic AccessScope = "public"
	// AccessScopePrivate represents private access (owner only, but can be shared).
