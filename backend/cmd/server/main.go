...
func main() {
	...
	repoHandler, docHandler, varHandler, execHandler, attachHandler, userHandler, groupHandler, viewHistoryHandler, viewStatsHandler, oauthHandler, gitProviderHandler, authHandler, jwtService, err := InitializeAPI(dbpool) // Pass dbpool and handle error
	if err != nil {
