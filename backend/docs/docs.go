...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/oauth/connections/{connectionId}/repositories/{owner}/{repo}/contents": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/documents/publish": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Document publish information",
                        "name": "document",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/opscore_backend_internal_document_interfaces_api_schema.PublishDocumentRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "opscore_backend_internal_document_interfaces_api_schema.PublishDocumentRequest": {
            "type": "object",
            "required": [
                "access_scope",
                "connection_id",
